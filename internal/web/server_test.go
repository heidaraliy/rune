...
func TestServerServesUIHealthAndProtectsAPI(t *testing.T) {
	...
	if ui.Code != http.StatusOK || !strings.Contains(ui.Body.String(), "What should Rune record?") || !strings.Contains(ui.Body.String(), "My Runes") || !strings.Contains(ui.Body.String(), "Tombstoned") || !strings.Contains(ui.Body.String(), "Parent Runes") || !strings.Contains(ui.Body.String(), "Child Runes") || !strings.Contains(ui.Body.String(), "Recent Activity") || !strings.Contains(ui.Body.String(), "Revision 1") || !strings.Contains(ui.Body.String(), "detail-meta-line") || !strings.Contains(ui.Body.String(), "rune-id-inline") || !strings.Contains(ui.Body.String(), "Status:") || !strings.Contains(ui.Body.String(), "data-detail-state=\"in_progress\"") || !strings.Contains(ui.Body.String(), "<textarea id=\"detail-title\"") || !strings.Contains(ui.Body.String(), "detail-body-wrap") || !strings.Contains(ui.Body.String(), "tombstone-overlay") || !strings.Contains(ui.Body.String(), "Save <span>⌘S</span>") || !strings.Contains(ui.Body.String(), "Queue Agent") || !strings.Contains(ui.Body.String(), "data-view=\"runes\"") || !strings.Contains(ui.Body.String(), "data-record-parent") || !strings.Contains(ui.Body.String(), "data-record-kind=\"idea\"") || !strings.Contains(ui.Body.String(), "brand-ascii") || !strings.Contains(ui.Body.String(), "fonts.googleapis.com") || strings.Contains(ui.Body.String(), "Shared state") || strings.Contains(ui.Body.String(), "All, including tombstones") || strings.Contains(ui.Body.String(), "CAPTURE") || strings.Contains(ui.Body.String(), "EXECUTION") || strings.Contains(ui.Body.String(), "HIERARCHY") || strings.Contains(ui.Body.String(), "Lifecycle") || strings.Contains(ui.Body.String(), "reversible tombstone") || strings.Contains(ui.Body.String(), "Save changes") || strings.Contains(ui.Body.String(), "Queue agent run") || strings.Contains(ui.Body.String(), "Recent activity") {
	...
	if styles.Code != http.StatusOK || !strings.Contains(styles.Body.String(), "--canvas: #0b0e1b") || !strings.Contains(styles.Body.String(), "--indigo:") || !strings.Contains(styles.Body.String(), "--type-heading: 26px") || !strings.Contains(styles.Body.String(), "--type-subheading: 18px") || !strings.Contains(styles.Body.String(), "--font-mono:") || !strings.Contains(styles.Body.String(), "Philosopher") || !strings.Contains(styles.Body.String(), ".collection-card") || !strings.Contains(styles.Body.String(), ".tombstone-overlay") || !strings.Contains(styles.Body.String(), ".kind-pill") || !strings.Contains(styles.Body.String(), ".state-pill") || strings.Contains(styles.Body.String(), "dashed") || strings.Contains(styles.Body.String(), "text-transform: uppercase") {
