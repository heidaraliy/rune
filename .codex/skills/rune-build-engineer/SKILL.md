...
description: Build and validation workflow for legacy and structured Rune code. Use for Go tests, SQLite/schema migrations, API or worker checks, artifact/run fixtures, dependencies, local binaries, and CI-equivalent commands.
---
...
- Use disposable databases, fake agent providers, local artifact roots, and ephemeral ports for structured Rune validation.
...
For structured Rune slices, add the focused package, migration, API, worker, or artifact
