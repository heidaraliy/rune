...
| Rune 2 domain/schema | entities, revisions, migrations, repositories | focused unit/schema/migration fixtures, then `go test ./...` |
...
| Graph/linkage | backlinks, dependencies, typed edges, neighborhoods | relation fixtures, orphan/duplicate checks, query/view tests |
